...
(
	...
	public_one_time_pre_keys BYTEA[]             NOT NULL
);

-- Create encrypted_private_keys table
CREATE TABLE encrypted_private_keys
(
	id                         SERIAL PRIMARY KEY,
	user_id                    UUID  NOT NULL REFERENCES users (id),
	encrypted_identity_key     BYTEA NOT NULL,
	encrypted_signed_pre_key   BYTEA NOT NULL,
	encrypted_one_time_pre_key BYTEA NOT NULL,
	encrypted_kyber_key        BYTEA NOT NULL,
